...
myStartupHook = do
         ...
         spawnOnce "picom -b --experimental-backends --config /home/jdv/github.com/jdvober/dotfiles/.config/picom/picom_custom.conf &"
         spawnOnce "numlockx &"
         -- spawnOnce "xmobar /home/jdv/.config/xmobar/.xmobarrc"
         -- -- spawnOnce "piactl connect"
         -- -- spawnOnce "rclone mount --daemon google-drive-work: ~/google-drive-work"
...
myWorkspaces = [" term ", " ed ", " www ", " files ", " misc1 ", " misc2 ", " misc3 ", " music "]
...
myKeys home =
    ...
    -- Run Prompt
        ...
        , ("M-<Space>", spawn "dmenu_run -b -i -dim 0.75 -h 30 -p '>' -fn 'JetBrains Mono' -nb '#282a36' -nf '#6272a4' -sb '#bd93f9' -sf '#282a36'") -- Dmenu
...
main = do
   ...
   xmproc2 <- spawnPipe "xmobar -x 0 $HOME/.config/xmobar/xmobarrc1"
